          ...
          <div className={`w-full lg:w-80 flex-shrink-0 border-r border-gray-100 flex flex-col ${mobileView === 'chat' ? 'hidden lg:flex' : 'flex'}`}>
            ...
            <div className="flex-1 overflow-y-auto">
              {MOCK_CONVERSATIONS.map((conv) => {
                ...
                const initials = `${conv.avocat.prenom.charAt(0)}${conv.avocat.nom.charAt(0)}`
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-gray-900 truncate">
                        Me {conv.avocat.prenom} {conv.avocat.nom}
                      </p>
              ...
              <div className="p-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900">
                    Me {selectedConv.avocat.prenom} {selectedConv.avocat.nom}
                  </p>
